pipeline {
    ...
    post {
        always {
            ...
            httpRequest(url: "http://api-portal.inveritasoft.com:22180/api/sendFile", httpMode: "POST", requestBody: '{chat_id: -1001240674447, documentPath: \"'+ $WORKSPACE +'/app/build/outputs/apk/debug/app-debug.apk }')
        }
        failure {
